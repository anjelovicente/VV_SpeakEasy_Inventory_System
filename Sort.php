...
if ($sorted == 'a'){
    $query = "select * from inventoryinfo order by drinkName ASC";
    $result_out = mysqli_query($sqlConnect, $query);
}
elseif ($sorted == 'b'){
    $query = "select * from inventoryinfo order by id ASC";
    $result_out = mysqli_query($sqlConnect, $query);
}
elseif ($sorted == 'c'){
    $query = "select * from inventoryinfo order by stocks ASC";
    $result_out = mysqli_query($sqlConnect, $query);
}
elseif ($sorted == 'd'){
    $query = "select * from inventoryinfo order by price ASC";
    $result_out = mysqli_query($sqlConnect, $query);
}
